...
print(set3)# output: {1, 2, 3, 'apple', 'bannana'}
print(set4)# output: {1, 2, 3, 4, 5}

#access elements in a set
# print(set1[0])  #Error: 'set' object dose not support indexing
...
set1.clear()
print(set1)
id_numbers = {198798, 3634767, 327628, 328765, 2390323}

#Remove first element of a set
id_numbers.pop()
print(id_numbers)
...
print(tuple2.icount(6)) #Output: 0
...
store1 = tuple_text.count("v")
store2  = tuple_text.count("V")
